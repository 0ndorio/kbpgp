...
(function() {
          ...
          if (v !== (b = _this.signed_hash_value_hash)) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/rnd/dev/kbpgp/src/openpgp/packet/signature.iced",
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            var _i, _len, _ref3;
            _ref3 = _this.hashed_subpackets;
            for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
              p = _ref3[_i];
              if (!(p instanceof VerificationAlgorithm)) {
                continue;
              }
              _this.key.pub.verification = p.verification_algorithm || C.verification_algorithms["default"];
              break;
            }
            return cb(err);
          });
  ...
  VerificationAlgorithm = (function(_super) {
    __extends(VerificationAlgorithm, _super);

    function VerificationAlgorithm(algorithm) {
      this.algorithm = algorithm;
      VerificationAlgorithm.__super__.constructor.call(this, S.verification_algorithm);
    }

    VerificationAlgorithm.parse = function(slice) {
      return new VerificationAlgorithm(slice.consume_rest_to_buffer());
    };

    VerificationAlgorithm.prototype._v_to_buffer = function() {
      return uint_to_buffer(8, this.algorithm);
    };
